 ...
 * @author phelipe
 */
@WebServlet(name = "FormaPagamentoExcluir", urlPatterns = {"/FormaPagamentoExcluir"})
public class FormaPagamentoExcluir extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if (dao.excluir(idFormaPagamento)){
                mensagem = "FormaPagamento excluido com Sucesso!";
            }else{
                mensagem = "Problemas ao excluir FormaPagamento!";
            }
            
            request.setAttribute("mensagem", mensagem);
            response.sendRedirect("FormaPagamentoListar");
        } catch (Exception ex){
            System.out.println("Problemas no Servelet ao excluir FormaPagamento! Erro: "+ex.getMessage());
        }
    }
