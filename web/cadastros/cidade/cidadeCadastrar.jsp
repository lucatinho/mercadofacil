...
<jsp:include page="/header.jsp"/>
        ...
        <form name="cadastrarcidade" action="CidadeCadastrar" 
                method="POST">
            ...
            <table align="center" border="0">
                ...
                <tbody>
                    <tr>
                        <td>ID: </td>
                        <td><input type="text" name="idcidade" 
                          id="idcidade" value="${cidade.idCidade}"
                          readonly="readonly" /></td>
                    </tr>
                    <tr>
                        <td>Nome: </td>
                        <td><input type="text" name="nomecidade" id="nomecidade" 
                         value="${cidade.nomeCidade}" size="50" 
                         maxlength="50" /></td>
                    </tr>
                    <tr>
                        <td>Estado: </td>
